# "pygame" - the python MOCKUP
# Copyright (C) License GNU GPL
# authors:
# Pete Shinners (original software) pete@shinners.org
# Thomas Iwaszko (feature replication & revamping) thomas@gaudia-tech.com
